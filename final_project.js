...
function funFact(){
if(random > 0.4){
alert("Polar bears only have a 2% rate of success while hunting!")
} else if(random < 0.5){
  alert("Polar bears can swim at up to 6 miles per hour, that is faster than Michael Phelps!")
} else if(random < 0.5){
  alert("Polar bears can weigh as much as a grand piano!")
} else if(random < 0.5){
alert("polarbearzs live in cold places.")
} else if(random < 0.5){
  alert("i like polarbears")
} else if(random < 0.5){
  alert("The most carnivorous of the bear species are polar bears. ")
} else if(random < 0.5){
alert(" polar bears have a vital role in their ecosystem.")
} else if(random < 0.5){
alert("Polar bears are marine mammals, and spend much of their time on Arctic sea ice.")
} else if(random < 0.5){
alert("Polar bears are the largest and longest species of bear. ")
} else if(random < 0.5){
alert("Males can measure up to 10 feet (3 meters) when standing on their hind legs.")
}
}
